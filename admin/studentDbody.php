...
<div class='   bg-stone-900 p-3 rounded-lg flex justify-center items-center w-[30%] text-slate-200 text-sm add-student'><a href="./addStudent.php">ADD STUDENT</a></div>

</div>
<table class="bg-white border-2 border-solid border-black border-collapse shadow-gray-600 rounded-2xl mt-16 bg-gradient-to-b from-slate-900 to-blue-900">
