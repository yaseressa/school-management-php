...
$parent = array('PARENT ', 'PARENT EMAIL', 'PARENT TEL');
if (isset($_GET['st'])) {
...
?>
<div class="translate-y-28 translate-x-80 overflow-y-visible  w-[80%] overflow-x-hidden">
    <div class='flex flex-col justify-center items-center z-20 m-10'>
        <img src="../resource/std_av.png" width="130" alt="" class="bg-stone-900 rounded-full  z-10">
        <h1><?= $student['name'] ?></h1>
    </div>
    <form action="" method="post" class=" w-[100%] flex flex-col justify-center items-center z-10">
        ...
        <a href="./studentDash.php" class=' mt-6  bg-stone-900 p-3 rounded-lg flex justify-center items-center w-36 text-slate-200 text-sm'>
            <div class=''>
