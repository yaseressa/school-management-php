...
<div class="left-[25%] top-[19%] relative w-[75%] overflow-hidden">
    <div class="mb-8">
        <h1 class="text-4xl mb-4 tracking-widest">SECTIONS</h1>
        <hr class="border-[5px] border-slate-900 rounded-full w-32 mb-5">
    </div>
    <div class="  flex flex-col  justify-start flex-wrap overflow-x-hidden mb-40">
        <div class="flex items-center justify-start gap-11 flex-wrap overflow-x-hidden">
            ...
            <div class="flex flex-row justify-center items-center relative hover:transition-opacity hover:scale-90 hover:cursor-pointer w-[45%] bg-gradient-to-tr from-gray-900 shadow-md shadow-gray-600 to-blue-900 mt-2 rounded-lg p-5 px-28 text-slate-200">
            ...
            <div class="flex flex-row justify-center items-center relative hover:transition-opacity hover:scale-90 hover:cursor-pointer  w-[45%] bg-gradient-to-tr from-gray-900 shadow-md shadow-gray-600 to-green-900 mt-2 rounded-lg p-5 px-28 text-slate-200">
    ...
    <div class="flex justify-evenly items-center">
        <div class=" mb-14 py-4 h-[50dvh] w-[40%] rounded-xl flex justify-start  items-center ">
            <canvas id="myChart" class=""></canvas>
        </div>
        <div class="w-[20%] rounded-xl flex flex-col justify-center  items-center ">
            <canvas id="pie"></canvas>
            <h1 class="text-[2rem] mt-6">DISTRIBUTIONS</h1>
        </div>
    </div>
