...
<div class='flex flex-col justify-center items-center z-20 m-10'><img src="../resource/subject-av.png" width="130" alt="" class="bg-stone-900 rounded-full  z-10"><h1><?= $ex['name']?></h1></div>
