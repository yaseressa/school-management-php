...
<div class=" flex flex-col items-center justify-center translate-y-32 translate-x-64 flex-wrap  w-[80%] overflow-x-hidden">
    <div class="flex md:flex-row flex-col w-[80%] justify-center items-center">
        ...
        <div class='   whitespace-nowrap md:m-0 m-4 bg-stone-900 md:p-3 p-4 px-7 rounded-lg flex justify-center items-center w-40 text-slate-200 text-sm add-student'>
