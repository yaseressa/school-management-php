...
?>
<dialog id="id" class="overflow-y-visible relative top-3 z-20 w-[100%] overflow-x-hidden flex flex-col justify-start items-center bg-white bg-opacity-30 backdrop-blur-sm h-screen">
    ...
    <div class="bg-white w-[700px] rounded-2xl">
        <div class="flex md:flex-row flex-col md:w-full w-[80%] justify-center items-center px-6">
...
<dialog open id="up" class="overflow-y-visible relative top-3 z-20 w-[100%] overflow-x-hidden flex flex-col justify-start items-center bg-white bg-opacity-30 backdrop-blur-sm h-screen">
    ...
    <form method="post" class=" w-[100%]  h-screen flex flex-col flex-wrap justify-center items-center ">
        <table class="bg-white rounded-2xl">
            <tr>
                ...
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" value="<?= $student['student_id'] ?>" type="text" name='<?= $attr[0] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[1] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input require class="h-12 w-[100%]" value="<?= $student['name'] ?>" type="text" name='<?= $attr[1] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[2] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="email" value="<?= $student['email'] ?>" name='<?= $attr[2] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[3] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="password" value="<?= $student['password'] ?>" name='<?= $attr[3] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[4] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="date" value="<?= $student['dob'] ?>" name='<?= $attr[4] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[5] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="text" value="<?= $student['sex'] ?>" name='<?= $attr[5] ?>'></td>
            </tr>
        </table>
        <table class="bg-white rounded-2xl">
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[6] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="text" value="<?= $student['Address'] ?>" name='<?= $attr[6] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[7] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input type="phone" class="h-12 w-[100%]" value="<?= $student['phone'] ?>" name='<?= $attr[7] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $attr[8] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input type="date" class="h-12 w-[100%]" value="<?= $student['date_of_join'] ?>" name='<?= $attr[8] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $part[0] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required type="text" class="h-12 w-[100%]" value="<?= $parent_t['name'] ?>" name='<?= $parent[0] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $part[1] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required type="email" class="h-12 w-[100%]" value="<?= $parent_t['email'] ?>" name='<?= $parent[1] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-stone-900 text-white"><?= $part[2] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input type="phone" class="h-12 w-[100%]" value="<?= $parent_t['phone'] ?>" name='<?= $parent[2] ?>'></td>
            </tr>

        </table>
        <div class=' md:top-16 md:bottom-auto bottom-[30%]   right-52 absolute bg-stone-900 p-3 rounded-lg flex justify-center items-center w-36 cursor-pointer text-slate-200 text-sm'><input name='submit' type="submit" value="UPDATE STUDENT"></div>
    </form>
