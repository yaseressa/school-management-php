...
<dialog open class="overflow-y-visible relative top-3 z-20 w-[100%] overflow-x-hidden flex flex-col justify-start items-center bg-white bg-opacity-30 backdrop-blur-sm h-screen">
    <div class=' md:top-16 md:bottom-auto md:bottom-auto bottom-[30%]    right-11 absolute bg-red-900 p-3 rounded-lg flex justify-center items-center w-36 cursor-pointer text-slate-200 text-sm' onclick="  window.location.replace('./subjectDash.php');">DISCARD</div>
    ...
    <form action="" method="post" class=" w-[100%]  overflow-y-hidden flex flex-col justify-center items-center z-10">
        <table class="bg-white border-2 border-solid border-black border-collapse shadow-gray-600 rounded-2xl">
            <tr>
                ...
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="text" value="<?= $subject['subject_id'] ?>" name='<?= $attr[0] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-orange-700 text-white"><?= $attr[1] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="text" value="<?= $subject['name'] ?>" name='<?= $attr[1] ?>'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-orange-700 text-white"><?= $attr[2] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="number" value="<?= $subject['grade_id'] ?>" name='grade'></td>
            </tr>
            <tr>
                <th class="p-3 md:px-24 text-sm bg-orange-700 text-white"><?= $attr[3] ?></th>
                <td class="p-3 md:px-24 border-2 border-solid border-stone-900"><input required class="h-12 w-[100%]" type="number" value="<?= $subject['teacher_id'] ?>" name='teacher'></td>
            </tr>
        ...
        <div class=' md:top-16 md:bottom-auto bottom-[30%]   right-52 absolute bg-orange-700 p-3 rounded-lg flex justify-center items-center w-36 cursor-pointer text-slate-200 text-sm'><input name='submit' type="submit" value="UPDATE SUBJECT"></div>
    </form>
